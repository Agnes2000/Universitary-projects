...
public:
    ...
    //void setParticles(const geometry_msgs::msg::PoseArray::SharedPtr particles); scommenta se non funziona
    void setParticles(const nav2_msgs::msg::ParticleCloud::SharedPtr particles); // commenta se non funziona
...
private:
    ...
    //geometry_msgs::msg::PoseArray::SharedPtr particles_; scommenta se non funziona
    nav2_msgs::msg::ParticleCloud::SharedPtr particles_;
