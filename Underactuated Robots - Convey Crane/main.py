# main.py
# Simulazione Convey-Crane: controllo basato su passività
...
from controllers.passivity import control_law
...
# ── Stato iniziale: come nel Test 1 del paper ──────────────────────
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    viewer.cam.distance  = 12.0      # invece di 8.0 — più ampio per includere x=-5
    viewer.cam.lookat[:] = [-2.5, 0, -0.5]   # centro tra punto di partenza e arrivo
...
plt.suptitle('Convey-Crane — Controllo basato su Passività', fontsize=14)
plt.tight_layout()
